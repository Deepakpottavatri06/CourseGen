        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                By aggregating content from various sources across the web, we ensure that you get
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">
                AI scan and curate content from thousands of sources to bring you the most
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              <a
                href="https://github.com/Deepakpottavatri06"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline"
              >
                <strong>P Deepak</strong>
              </a>
              &nbsp;and&nbsp;
              <a
                href="https://github.com/MaruthiCharan2403"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:underline"
              >
                <strong>YSS Maruthi Charan</strong>
              </a>
            </p>
          </div>
